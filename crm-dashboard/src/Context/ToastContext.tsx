import React, { ReactNode, useState, useCallback, useRef, useEffect, useMemo, createContext } from 'react';
...
export const ToastProvider: React.FC<ToastProviderProps> = ({
	...
	const addToast = useCallback(
		(message: string, type: string = TOAST_TYPES.SUCCESS, duration: number = DEFAULT_DURATION) => {
